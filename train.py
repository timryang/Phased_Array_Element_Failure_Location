...
parser = argparse.ArgumentParser(description='Phased Array Dead Element Estimation')
...
def main():
    ...
    # traindir = os.path.join(args.data, '30dB_500Its_M4_Size8_Train')
    # testdir = os.path.join(args.data, '30dB_50Its_M4_Size8_Test')
    traindir = ['/content/drive/My Drive/ECE6254_Project/Code/Patterns/Train']
    testdir = ['/content/drive/My Drive/ECE6254_Project/Code/Patterns/Test']
    
    # Image downsample size
    resize_val = 2**8
    ...
    train_dataset = utils.ArrayDataset(traindir, transform)
    train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True,
                                               num_workers=args.workers, pin_memory=True)

    test_dataset = utils.ArrayDataset(testdir, transform)
    ...
    savedir = 'Test'
    checkpointdir = os.path.join('/content/drive/My Drive/ECE6254_Project/checkpoints', savedir)
